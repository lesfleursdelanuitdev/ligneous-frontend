...
export default function TreeSurnamesPage() {
  ...
  const headers = [{ label: 'Surname', key: 'name', sortable: false }, { label: 'Count', key: 'frequency', sortable: false }];
      ...
      <div className="p-6 max-w-6xl mx-auto space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl font-bold text-base-content">Surnames</h1>
            <p className="text-base-content/60 mt-1">{items.length} surnames</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="card bg-base-100 border border-base-content/10 p-12 text-center rounded-box"><p className="text-base-content/60">No surnames in this tree.</p></div>
        ) : (
          <DataView
            view={view}
            items={items}
