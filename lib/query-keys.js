export const queryKeys = {
  trees: {
    ...
    stats: (treeId) => ['trees', treeId, 'stats'],
    activity: (treeId) => ['trees', treeId, 'activity'],
    health: (treeId) => ['trees', treeId, 'health'],
    settings: (treeId) => ['trees', treeId, 'manage', 'settings'],
  },
  entities: {
  ...
  nlSearch: {
    suggestions: (treeId) => ['trees', treeId, 'nl-search', 'suggestions'],
  },
  threads: {
  ...
  albums: {
    list: (treeId, params) => ['albums', treeId, params],
    detail: (treeId, albumId) => ['album', treeId, albumId],
    media: (treeId, albumId) => ['album', treeId, albumId, 'media'],
  },
};
